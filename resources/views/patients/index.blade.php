<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('patients.create') }}" class="dental-button">
                ...
                <div class="mb-4">
                    <form action="{{ route('patients.index') }}" method="GET" class="flex items-center">
                        <div class="relative flex-grow">
                            <input type="text" name="search" value="{{ $search ?? '' }}" class="dental-input pr-10" placeholder="Search patients...">
                        ...
                        <button type="submit" class="ml-2 dental-button">Search</button>
                        @if($search)
                            <a href="{{ route('patients.index') }}" class="ml-2 dental-button-secondary">Clear</a>
                        @endif
                    </form>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('patients.show', $patient) }}" class="text-dental-primary hover:text-dental-secondary">
